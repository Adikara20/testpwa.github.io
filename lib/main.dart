...
import 'package:test_flutter_pwa/constant.dart';
import 'package:test_flutter_pwa/utils.dart';
import 'package:test_flutter_pwa/webview.dart';
...
class _MyAppState extends State<MyApp> with WidgetsBindingObserver {
  ...
  void resumeAll() {
    if (defaultTargetPlatform == TargetPlatform.android) {
      var resume = webViewController?.resume();
    }
